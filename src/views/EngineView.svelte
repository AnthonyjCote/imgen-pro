...
<section class="engine-layout">
  <div class="settings-panel">
    <div class="panel-intro">
      ...
      <p>Begin in mock mode. Switch to the process adapter after your Vulkan/MoltenVK build of stable-diffusion.cpp is available.</p>
    </div>
    ...
    <div class="button-row">
      ...
      <button class="secondary-button" disabled={busy} onclick={onProbe}>Probe engine</button>
